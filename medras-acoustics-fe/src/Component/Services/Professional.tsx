...
export const Professional = () => {
  ...
  const sections = [
    { title: "Music Studios", image: "/images/acoustic-1.jpeg", description: "Detailed information about Music Studios." },
    { title: "Film Mix Stages", image: "/images/acoustic-1.jpeg", description: "Detailed information about Film Mix Stages." }
  ];
  return (
    <>
    ...
    <div className="professional-container">
      ...
      <div className="service-section">
        ...
        <div className="service-image">
          <img src="/images/acoustic-1.jpeg" alt="Professional Service" />
        </div>
      </div>
